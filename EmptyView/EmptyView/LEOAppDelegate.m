...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.mainViewController=  [[MainViewController alloc]initWithNibName:nil bundle:NULL];
    self.mainNavigationController=[[UINavigationController alloc]initWithRootViewController:self.mainViewController];
    
    NSArray *controllers=[[NSArray alloc] initWithObjects:self.mainNavigationController,self.rootNavigationController, nil];
